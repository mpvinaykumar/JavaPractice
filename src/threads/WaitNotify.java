...
public class WaitNotify {
	...
	public void produce() throws InterruptedException {
		synchronized (this) {
			 ...
			 * behaves exactly as if it simply performs the call wait(0). The current thread
			 * must own this object's monitor. The thread releases ownership of this monitor
			 * and waits until another thread notifies threads waiting on this object's
			 * monitor to wake up either through a call to the notify method or the
	...
	public void consume() throws InterruptedException {
		...
		synchronized (this) {
			 ...
			 * awakened thread will not be able to proceed until the current thread
			 ...
			 * object. This method should only be called by a thread that is the owner of
			 * this object's monitor. A thread becomes the owner of the object's monitor in
			 * one of three ways: By executing a synchronized instance method of that
			 * object.By executing the body of a synchronized statement that synchronizes
			 */
			notify();
